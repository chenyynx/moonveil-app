...
object ReadImageTool {
    ...
    fun definition(): AgentToolDefinition = AgentToolDefinition(
        ...
        parameters = mapOf(
            ...
            "path" to AgentToolParam("string", "Linux path (e.g. /var/minis/attachments/chart.png) or moonveil:// URL (e.g. moonveil://attachments/chart.png)"),
    ...
    fun execute(argsJson: String, sessionId: String? = null, context: Context? = null): ToolExecutionResult {
        return try {
            ...
            val path = if (rawPath.startsWith("moonveil://")) {
                "/var/minis/" + java.net.URLDecoder.decode(rawPath.removePrefix("moonveil://"), "UTF-8")
            } else rawPath
