...
class ModelsCollection(
    ...
    override fun add(payload: ConfigValue): String {
        ...
        // (CLI-facing alias documented in `moonveil-config` help). Either
    ...
    /**
     * Canonical names matching `moonveil-model-use list` so the two tools
    ...
    private fun effectiveModalities(e: ModelEntry): List<String> {
        ...
        // direction-suffixed names that match `moonveil-model-use list`.
