#!/usr/bin/env python3
"""daemon.py — the forked, long-lived background process behind moonveil-mcp-cli.
...
import sys
sys.path.insert(0, "/usr/local/lib/moonveil-mcp-cli")
    ...
    def _handshake(self):
        ...
        try:
            self._rpc("initialize", {
                ...
                "capabilities": {},
                "clientInfo": {"name": "moonveil-mcp-cli", "version": "1.0.0"},
            }, timeout=timeout)
