...
static NSString *const HELP_TEXT =
    @"apple-alarm - Set alarms and timers on iOS (AlarmKit, iOS 26+)\n"
     ...
     "\n"
     "DEEP LINK:\n"
     "  moonveil://views/alarm              Open the alarm management page in Moonveil\n";
    ...
    if (!authorized) {
        NSString *msg = authError
            ? [NSString stringWithFormat:@"AlarmKit authorization failed: %@. "
                "To grant access, open Settings > Privacy & Security > Alarms and enable Moonveil.",
...
static int cmd_set_alarmkit(int argc, char **argv, int stdout_fd,
    ...
    if (@available(iOS 26.0, *)) {
        ...
        data[@"view_url"] = @"moonveil://views/alarm";
        data[@"hint"] = @"Alarm is now visible on the Moonveil home screen. Open moonveil://views/alarm to manage alarms.";
...
static int cmd_timer_alarmkit(int argc, char **argv, int stdout_fd,
    ...
    if (@available(iOS 26.0, *)) {
        ...
        data[@"view_url"] = @"moonveil://views/alarm";
        data[@"hint"] = @"Timer is now visible on the Moonveil home screen. Open moonveil://views/alarm to manage alarms.";
