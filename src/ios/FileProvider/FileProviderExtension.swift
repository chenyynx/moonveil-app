...
final class FileProviderExtension: NSObject, NSFileProviderReplicatedExtension {
    ...
    private static let log = OSLog(subsystem: "com.moonveil.app.FileProvider", category: "Extension")

    /// Root directory for all FileProvider-visible files in the App Group container.
    static var providerRoot: URL {
        let container = FileManager.default.containerURL(
            forSecurityApplicationGroupIdentifier: "group.com.moonveil.app"
        )!
    ...
    private static func cleanupLegacyLogsDirIfNeeded(root: URL) {
        ...
        if let container = fm.containerURL(forSecurityApplicationGroupIdentifier: "group.com.moonveil.app") {
    ...
    private static func cleanupLegacyMountedFoldersIfNeeded(root: URL) {
        ...
        guard let container = fm.containerURL(forSecurityApplicationGroupIdentifier: "group.com.moonveil.app") else { return }
