...
final class AppGroupChangeWatcher {
    ...
    private let queue = DispatchQueue(label: "com.moonveil.app.fpwatcher", qos: .utility)
    private let domainIdentifier = NSFileProviderDomainIdentifier("com.moonveil.app.files")
