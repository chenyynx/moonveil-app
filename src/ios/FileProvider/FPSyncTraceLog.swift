...
enum FPSyncTraceLog {
    ...
    private static let queue = DispatchQueue(label: "com.moonveil.app.FileProvider.fpSyncTrace")
    private static let osLog = OSLog(subsystem: "com.moonveil.app.FileProvider", category: "FPSyncTrace")
