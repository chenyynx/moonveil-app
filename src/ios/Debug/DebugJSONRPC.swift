...
final class DebugJSONRPC: @unchecked Sendable {
    ...
    private func handleSyncCKQuery(params: [String: Any]) async -> Any {
        ...
        let container = CKContainer(identifier: "iCloud.com.moonveil.app")
        do {
    ...
    private func handleSyncZoneStats(params: [String: Any]) async -> Any {
        let containerId = "iCloud.com.moonveil.app"
    ...
    /// installed XCTest automation service (bundle com.moonveil.ictrl,
    ...
    static func forwardTapToICTRL(params: [String: Any]) async -> [String: Any]? {
        ...
        let bundleId = (params["ictrl_bundle_id"] as? String) ?? Bundle.main.bundleIdentifier ?? "com.moonveil.app"
