...
final class GeminiOAuthManager: NSObject, ObservableObject {
    ...
    static let legacyKeychainService = "com.moonveil.app.gemini-oauth"
    static let legacyKeychainAccount = "token"
    static let legacyEmailKey = "com.moonveil.app.gemini-email"
    static let legacyProjectIDKey = "com.moonveil.app.gemini-gcp-project"
