...
//
//  Ownership split with the in-guest moonveil-mcp-cli:
...
struct MCPOAuthConfig: Codable, Hashable {
    ...
    var scopes: String?
    /// Custom redirect URI. Default moonveil-mcp://oauth/callback; Google installed
...
final class MCPOAuthController: NSObject, ObservableObject {
    ...
    nonisolated private static let keychainService = "com.moonveil.app.mcp-oauth"
    ...
    /// `moonveil-mcp-cli add --oauth-client-secret` can't reach the Keychain from
