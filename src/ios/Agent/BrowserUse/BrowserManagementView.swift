...
struct BrowserManagementView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog("Clear All Cookies?", isPresented: $showClearConfirm, titleVisibility: .visible) {
            ...
            Text("This will remove all cookies and website data from the Moonveil browser.")
        }
        .task {
            await loadCookies()
        }
    ...
    private var cookiesSection: some View {
        Section {
            ...
            Text("Clearing cookies will sign you out of all websites in the Moonveil browser.")
        }
    }
