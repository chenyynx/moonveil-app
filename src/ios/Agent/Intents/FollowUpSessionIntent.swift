...
struct FollowUpSessionIntent: AppIntent {
    ...
    static var description = IntentDescription("Sends a follow-up prompt to an existing Moonveil session, continuing the conversation with the AI agent.")
    ...
    func perform() async throws -> some IntentResult & ReturnsValue<SendPromptResult> & ProvidesDialog {
        ...
        if sendCompletionNotification {
            ...
            ShortcutNotification.post(
                ...
                title: AppLocalized("Moonveil: Follow-up Sent"),
        ...
        if waitForResult {
            ...
            if sendCompletionNotification {
                ShortcutNotification.post(
                    ...
                    title: AppLocalized("Moonveil: Follow-up Done"),
