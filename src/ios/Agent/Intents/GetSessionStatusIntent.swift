...
struct GetSessionStatusIntent: AppIntent {
    ...
    static var description = IntentDescription("Gets the current status of a Moonveil session, including whether the agent is still running, the latest message, and last tool call.")
