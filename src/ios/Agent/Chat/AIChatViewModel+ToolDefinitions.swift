        ...
        if nativeVision || visionGroupConfigured {
            ...
            tools.append(AgentToolDefinition(
                ...
                parameters: [
                    ...
                    "path": AgentToolParam(type: .string, description: "Linux path (e.g. /var/minis/attachments/chart.png) or moonveil:// URL (e.g. moonveil://attachments/chart.png)"),
