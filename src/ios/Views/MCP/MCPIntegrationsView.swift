...
struct MCPIntegrationsView: View {
    /// [T-mcp-oauth-deeplink] When set (moonveil://settings/mcp-servers/<id>),
    ...
    var body: some View {
        ...
        // server written by moonveil-mcp-cli after launch shows up without an app
...
/// refresh (`moonveil-mcp-cli refresh <name>`: evict the daemon session,
