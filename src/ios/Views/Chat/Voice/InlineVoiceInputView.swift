...
struct InlineVoiceInputView: View {
    ...
    private var correctionButton: some View {
        ...
        .alert(AppLocalized("Improve voice corrections?",
            ...
            Text("Moonveil can store your transcript fixes (original → corrected pairs) and accepted AI corrections in a local on-device database to make future voice corrections smarter. Nothing is uploaded. You can change this or clear the data anytime in Settings → Permissions.",
