    ...
    private static func performTest(_ kind: ModelQuickTestSheet.Kind, entry: ModelEntry) async throws -> TestRun.State {
        ...
        case .text:
            ...
            let messages = [LLMMessage(
                role: .user,
                content: "Hi! I'm setting you up in Moonveil. Say hello back in one short, friendly sentence.")]
        ...
        case .imageGen:
            ...
            let resp = try await openAI.generateImage(
                prompt: "A friendly cute mascot logo for an app called Moonveil, minimalist, centered, soft colors",
        ...
        case .speechOut:
            ...
            let req = VoiceOutputRequest(
                input: "Hi! This is Moonveil testing text to speech.",
        ...
        case .transcription:
            ...
            let spoken = "Hello from Moonveil, testing speech to text."
